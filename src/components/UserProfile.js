...
export default class UserProfile extends Component {
  ...
  componentDidMount(){
    ...
    if (user != null) {
      ...
      bookmarkBtn.innerHTML = "My Bookmarks"
      ...
      userRef.once('value', function(snapshot) {
        ...
        document.getElementById('usernameText').innerHTML = usernameString;
    ...
    return (
      <div>
        <div id="addModal" className="modal">
          <span onClick={closePod} className="close">×</span>
          <div className="modal-content-collectionadd">
            <h1 className="collectionAddText">Add A Collection</h1>
            <p className="collectionAddText">Name your collection:</p>
            <input id="collectionName" className="collectionAddName"></input>
            <button id="confirmAdd" className="collectionConfirmAdd" onClick={() => {addToCollection();}}>Add to my Profile</button>
          </div>
        </div>
        ...
        <Node if={item.isVideoYoutube}>
          <Node then>
                <div className='gallery-caption'>
                  ...
                  <FontAwesome onClick={(e) => {addCollections(e, item);}} className="addCollectionIcon" id='collection' name="plus" style={{ textShadow: '0 1px 0 rgba(0, 0, 0, 0.1)' }}/>
                  <FontAwesome onClick={(e) => {addBookmark(e, item);}} className="addCollectionIcon" id={item.keyString} name="bookmark-o" style={{ textShadow: '0 1px 0 rgba(0, 0, 0, 0.1)' }}/>
          ...
          <Node else><div className='gallery-caption'>{item.title}
              <FontAwesome onClick={(e) => {addCollections(e, item);}}  className="addCollectionIcon" id='collection' name="plus" style={{ textShadow: '0 1px 0 rgba(0, 0, 0, 0.1)' }}/>
              <FontAwesome onClick={(e) => {addBookmark(e, item);}} className="bookmark" id={item.keyString} name="bookmark-o" style={{ textShadow: '0 1px 0 rgba(0, 0, 0, 0.1)' }}/>
              <p className='bookedCount'> {item.bookedCount}</p>
            </div>
                <div className='addCollections' id={item.timeStamp}>
                    <div id={item.timeStamp} className="collectionButtonsFeed">
